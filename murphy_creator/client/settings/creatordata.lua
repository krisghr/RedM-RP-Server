...
EyeColours = {
    {
        ...
        tintAmount = 14,
        colours = {
            { id = "1", image = "./img/colours/eye_color_14.png" },
            { id = "2", image = "./img/colours/eye_color_13.png" },
            { id = "3", image = "./img/colours/eye_color_8.png" },
            { id = "4", image = "./img/colours/eye_color_2.png" },
            { id = "5", image = "./img/colours/eye_color_3.png" },
            { id = "6", image = "./img/colours/eye_color_4.png" },
            { id = "7", image = "./img/colours/eye_color_1.png" },
            { id = "8", image = "./img/colours/eye_color_6.png" },
            { id = "9", image = "./img/colours/eye_color_7.png" },
            { id = "10", image = "./img/colours/eye_color_9.png" },
            { id = "11", image = "./img/colours/eye_color_5.png" },
            { id = "12", image = "./img/colours/eye_color_12.png" },
            { id = "13", image = "./img/colours/eye_color_11.png" },
            { id = "14", image = "./img/colours/eye_color_10.png" }
        },
        tintValue = 1
    }
}
